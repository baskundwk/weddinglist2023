...
class wdl_settings
{
	...
	private $fields = [
		...
		[
			'id' => 'word-frontpage-promotion-desc',
			'label' => 'Front Page - Promotion Description',
			'description' => '',
			'type' => 'text',
		],
		[
			'id' => 'word-frontpage-wedding-fair-title',
			'label' => 'Front Page - Wedding Fair Title',
			'description' => '',
			'type' => 'text',
		],
		[
			'id' => 'word-frontpage-wedding-fair-desc',
			'label' => 'Front Page - Wedding Fair Description',
			'description' => '',
			'type' => 'text',
		],
		[
			'id' => 'word-frontpage-venue-title',
			'label' => 'Front Page - Venue Title',
			'description' => '',
			'type' => 'text',
		],
		[
			'id' => 'word-frontpage-venue-desc',
			'label' => 'Front Page - Venue Description',
			'description' => '',
			'type' => 'text',
		],
		[
			'id' => 'word-frontpage-vendor-title',
			'label' => 'Front Page - Vendor Title',
			'description' => '',
			'type' => 'text',
		],
		[
			'id' => 'word-frontpage-vendor-desc',
			'label' => 'Front Page - Vendor Description',
			'description' => '',
			'type' => 'text',
		],
		[
		...
		[
			'id' => 'word-frontpage-post-desc',
			'label' => 'Front Page - Post Description',
			'description' => '',
			'type' => 'text',
		],
		[
			'id' => 'word-promotion-title',
			'label' => 'Promotion Archive Title',
			'description' => '',
			'type' => 'text',
		],
		[
			'id' => 'word-promotion-desc',
			'label' => 'Promotion Archive Description',
			'description' => '',
			'type' => 'text',
		],
		[
			'id' => 'word-wedding-fair-title',
			'label' => 'Wedding Fair Archive Title',
			'description' => '',
			'type' => 'text',
		],
		[
			'id' => 'word-wedding-fair-desc',
			'label' => 'Wedding Fair Archive Description',
			'description' => '',
			'type' => 'text',
		],
		[
			'id' => 'word-venue-title',
			'label' => 'Venue Archive Title',
			'description' => '',
			'type' => 'text',
		],
		[
			'id' => 'word-venue-desc',
			'label' => 'Venue Archive Description',
			'description' => '',
			'type' => 'text',
		],
		[
			'id' => 'word-vendor-title',
			'label' => 'Vendor Archive Title',
			'description' => '',
			'type' => 'text',
		],
		[
			'id' => 'word-vendor-desc',
			'label' => 'Vendor Archive Description',
			'description' => '',
			'type' => 'text',
		],
		[
	...
	function render_options_page(): void
	{
		...
		if (isset($_GET['settings-updated'])) {
			...
			add_settings_error('wporg_messages', 'wporg_message', __('Settings Saved', 'weddinglist-setting'), 'updated');
		}
		...
		<div class="wrap">
			...
			<form action="options.php" method="post">
				...
				settings_fields('weddinglist-setting');
				/* output setting sections and their fields */
				/* (sections are registered for "wporg", each field is registered to a specific section) */
				do_settings_sections('weddinglist-setting');
	...
	function render_field(array $args): void
	{
		...
		$options = get_option('wdl_options');
		...
		switch ($field['type']) {
			...
			case "text": {
				?>
					<input style="width: 100%"
						...
						name="wdl_options[<?php echo esc_attr($field['id']); ?>]"
						value="<?php echo isset($options[$field['id']]) ? esc_attr($options[$field['id']]) : ''; ?>">
					<p class="description">
					<?php esc_html_e($field['description'], 'weddinglist-setting'); ?>
					</p>
					<?php
					break;
			}
			...
			case "textarea": {
				?>
					<textarea
						id="<?php echo esc_attr($field['id']); ?>"
						name="wdl_options[<?php echo esc_attr($field['id']); ?>]"><?php echo isset($options[$field['id']]) ? esc_attr($options[$field['id']]) : ''; ?></textarea>
					<p class="description">
					<?php esc_html_e($field['description'], 'weddinglist-setting'); ?>
					</p>
					<?php
			...
			case "wysiwyg": {
				wp_editor(
					...
					$field['id'],
					array(
						'textarea_name' => 'wdl_options[' . $field['id'] . ']',
						'textarea_rows' => 5,
					)
				);
				break;
