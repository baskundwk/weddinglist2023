					...
					<?php
						...
						$venueTitle = get_the_title($venue->ID); ?>
							<p class="wdl-archive-location mb-0">
								<a class="wdl-data-venue" href="<?php echo esc_html($venuePermalink)?>"><?php echo esc_html( $venueTitle ); ?></a>
							</p>
										...
										<div id="wdl-post-<?php the_ID(); ?>" class="swiper-slide card wdl-archive-card <?php echo esc_attr($atts['class_single']); ?>">
											...
											<div class="card-body wdl-archive-card-body">
												...
												<div class="wdl-archive-pretitle mb-2">
													...
													if ($relatedVenue) : ?>
														<small><?php echo $relatedVenueType->name ?></small>
													<?php endif; ?>
												</div>
												...
												$venueTitle = get_the_title($venue->ID); ?>
													<p class="wdl-archive-location mb-0">
														<a href="<?php echo esc_html($venuePermalink)?>"><?php echo esc_html( $venueTitle ); ?></a>
													</p>
												<?php endforeach; endif; ?>
											</div>
										</div>
