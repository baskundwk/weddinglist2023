    ...
    <div class="container-xxl container-archive wdl-archive-infinite-scroll">
      ...
      <?php if (have_posts()): ?>
        ...
        <div class="row pb-4">
          <div class="col">
            <h1>
              <?php echo _e('โปรโมชั่นแต่งงาน & แพ็กเกจแต่งงาน') ?>
            </h1>
            <p class="text-secondary">
              <?php echo _e('รวมโปรโมชั่น และ แพ็กเกจแต่งงาน จากสถานที่จัดงานแต่งงานชั้นนำทุกรูปแบบ อัพเดทล่าสุด 2023') ?>
            </p>
          </div>
        </div>
        <div class="row row-cols-archive row-cols-archive-randomized g-4 wdl-archive-infinite-scroll-wrapper" id="wdl-archive-infinite-scroll-wrapper">
          <?php while (have_posts()): ?>
            ...
            <div id="wdl-post-<?php the_ID(); ?>" class="col wdl-archive-infinite-scroll-post  <?php echo esc_attr($atts['class_single']); ?> <?php if (get_field('HotDeal')) {
