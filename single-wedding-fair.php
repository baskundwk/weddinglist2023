			...
			<div class="row align-items-center text-center text-sm-start">
				...
				<div class="col-sm mb-3 mb-sm-0">
					...
					<?php
						$date = get_field('Date');
						if ($date) : ?>
							<p><span class="badge wdl-badge-sm-primary"><?php the_field('Date') ?></span></p>
						<?php endif; ?>
					<?php
				...
				<div class="col-sm-auto text-center text-sm-end">
					<a href="#apply" class="wdl-btn-lg" data-bs-toggle="modal"><?php _e('ลงทะเบียน<br class="d-sm-none">เพื่อรับสิทธิพิเศษ', 'Get Privilege'); ?></a>
				</div>
			</div>
		</div>
	</section>
	<section>
		<div class="container-xl">
			...
			<?php $afterContent = get_field('AfterContent');
				...
				if ( $tel) : ?>
				<div class="col">
					<p><?php _e('โทร', 'Tel') ?> : <?php the_field('Tel') ?></p>
				</div>
				<?php endif ?>
				<?php $email = get_field('FormRecepient');
				if ( $email) : ?>
				<div class="col">
					<p><?php _e('อีเมล', 'Email') ?> : <?php the_field('FormRecepient') ?></p>
				</div>
				<?php endif ?>
			</div>
		</div>
		...
		<div class="modal-dialog modal-dialog-centered">
			<div class="modal-content">
				...
				<div class="modal-body">
					<p class="wdl-archive-location mb-0"><?php echo esc_html( $venueTitle ); ?></p>
										...
										<div id="wdl-post-<?php the_ID(); ?>" class="swiper-slide card wdl-archive-card <?php echo esc_attr($atts['class_single']); ?>">
											...
											<div class="card-body wdl-archive-card-body">
												...
												<div class="wdl-archive-location">
													...
													$relatedVenue = get_field('RelatedVenue');
													if ($relatedVenue) : ?>
														<a href="<?php echo esc_html(get_permalink($relatedVenue)); ?>"><?php echo esc_html($relatedVenue->post_title); ?></a>
													<?php endif; ?>
												</div>
											</div>
										</div>
