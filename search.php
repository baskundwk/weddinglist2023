...
<section>
  <?php if( have_posts() ){
    ...
    forEach($posts as $eachPost) {
      if($eachPost->post_type === 'promotion'){$countPromotion++;}
      if($eachPost->post_type === 'wedding-fair'){$countWeddingFair++;}
      if($eachPost->post_type === 'venue'){$countVenue++;}
      if($eachPost->post_type === 'post'){$countPost++;}
    }
                      ...
                      while( have_posts() ){
                          ...
                          if( $type === get_post_type() ){
                            ...
                            <div class="col">
                              ...
                              <div class="card-body wdl-archive-card-body">
                                <h3 class="wdl-archive-title"><a href="<?php the_permalink(); ?>"><?php echo wp_trim_words(get_the_title(), 80) ?></a></h3>
                              </div>
