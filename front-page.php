          ...
          <div id="promotions" class="swiper wdl-archive-swiper overflow-visible">
            <div class="swiper-wrapper row-cols-archive-randomized">
              <?php while ($promotion->have_posts()) : ?>
                ...
                <div id="wdl-post-<?php the_ID(); ?>" class="swiper-slide card wdl-archive-card <?php echo esc_attr($atts['class_single']); ?> <?php if(get_field('HotDeal')) {echo esc_html('wdl-archive-primary');} else {echo esc_html('wdl-archive-default');}?>">
            ...
            <?php if ($venue->have_posts()) : ?>
              <div class="row row-cols-1 row-cols-sm-2 row-cols-lg-3 g-3 row-cols-archive-randomized">
                ...
                <?php while ($venue->have_posts()) : ?>
                  ...
                  <div class="col <?php if ($sponsored && in_array('Sponsored', $sponsored)) { echo('order-first'); } ?> <?php if(get_field('Sponsor')) {echo esc_html('wdl-archive-primary');} else {echo esc_html('wdl-archive-default');}?>">
