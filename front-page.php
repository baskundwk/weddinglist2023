...
<main>
  ...
  <?php $sectionEnabled = get_field('enable_tw_review_section', 'option');
  if ($sectionEnabled) : ?>
    ...
    if ($twReviews->have_posts()) : ?>
      <section class="py-5 bg-gray wdl-tw2026-register overflow-hidden" style="background-image: url('/wp-content/uploads/2026/01/review-bg.webp')">
        <div class="container-xl">
          <h2 class="text-center fs-4 mb-4">รีวิวจากผู้เข้าร่วมงาน<br />
  ...
  <?php if (
    ...
    <section class="html-lazy section-stripe pt-4 pb-3">
      <?php include get_stylesheet_directory() . '/components/top-content.php' ?>
      <div class="container-xl">
