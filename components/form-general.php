                ...
                <div class="col-md-6">
                  <div class="form-floating">
                    <select class="form-select" id="appoint-time" placeholder="วันที่ต้องการนัดหมาย">
                      ...
                      <option value="ช่วงเช้า (09:00 - 12:00 น.)"><?php _e('ช่วงเช้า (09:00 - 12:00 น.)','wdl') ?></option>
                      <option value="ช่วงบ่าย (12:00 - 16:00 น.)"><?php _e('ช่วงบ่าย (12:00 - 16:00 น.)','wdl') ?></option>
                      <option value="ช่วงเย็น (16:00 - 19:00 น.)"><?php _e('ช่วงเย็น (16:00 - 19:00 น.)','wdl') ?></option>
                      <option value="ช่วงค่ำ (19:00 - 22:00 น.)"><?php _e('ช่วงค่ำ (19:00 - 22:00 น.)','wdl') ?></option>
                    </select>
