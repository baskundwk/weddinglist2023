      ...
      <div class="modal-body p-4">
        ...
        <form id="wdl-form-general" class="wdl-form-general" action="" method="post" enctype="multipart/form-data">
          <div class="row g-3">
            ...
            <div class="col-md-12">
              <div class="form-floating">
                <textarea class="form-control" name="message" id="message" label="ข้อความเพิ่มเติม"></textarea>
                <label for="message">ข้อความเพิ่มเติม</label>
              </div>
            </div>
            <div class="col-md-12">
              <div class="d-block"><label>ช่วงเวลาจัดงาน</label></div>
              <div class="wdl-checkbox d-block my-3"><input type="checkbox" name="daytime" id="daytime-1" value="งานเลี้ยงเช้า"/><label for="daytime-1">งานเลี้ยงเช้า</label></div>
              <div class="wdl-checkbox d-block my-3"><input type="checkbox" name="daytime" id="daytime-2" value="งานเลี้ยงเที่ยง"/><label for="daytime-2">งานเลี้ยงเที่ยง</label></div>
              <div class="wdl-checkbox d-block my-3"><input type="checkbox" name="daytime" id="daytime-3" value="งานเลี้ยงเย็น"/><label for="daytime-3">งานเลี้ยงเย็น</label></div>
            </div>
