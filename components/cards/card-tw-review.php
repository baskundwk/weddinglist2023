<div class="wdl-card-twreview" style="background-image: url('https://www.weddinglist.co.th/wp-content/uploads/2026/01/tw-review-bg.webp')">
  <div class="wdl-card-twreview-top">
    <?php if (get_the_post_thumbnail()) : ?>
      <div class="wdl-card-twreview-thumbnail gradient">
  ...
  if (!empty($gallery)) : ?>
    <div class="wdl-card-twreview-gallery">
  ...
  <div class="wdl-card-twreview-content">
