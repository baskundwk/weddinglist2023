<div id="wdl-post-<?php the_ID(); ?>" class="swiper-slide wdl-archive-card wdl-archive-infinite-scroll-post position-relative">
    ...
    <a href="<?php echo esc_attr(the_permalink()) ?>" aria-label="<?php echo esc_attr(get_the_title()) ?>"
      ...
      <div class="wdl-video-text">
        <p class="meta lineclamp-1">
          ...
          if ($videoCategories) {
            $videoCategoriesLength = count($videoCategories) || 0;
