  ...
  <div class="container-xl">
    <div class="wdl-result-empty-inner">
      <div class="wdl-result-empty-image">
        <svg viewBox="0 0 24 24" width="100" height="100" stroke="currentColor" stroke-width="1" fill="none" stroke-linecap="round" stroke-linejoin="round" class="css-i6dzq1"><circle cx="11" cy="11" r="8"></circle><line x1="21" y1="21" x2="16.65" y2="16.65"></line></svg>
      </div>
