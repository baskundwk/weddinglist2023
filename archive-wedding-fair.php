      ...
      <?php if (have_posts()): ?>
        ...
        <div class="row pb-4">
          <div class="col">
            ...
            <p class="text-secondary">
              <?php echo _e('รวบรวม Wedding Fair ให้คุณไว้ที่เดียว', 'รวบรวม Wedding Fair ให้คุณไว้ที่เดียว') ?>
            </p>
          </div>
        </div>
        <div class="row row-cols-archive row-cols-archive-randomized g-4 wdl-archive-infinite-scroll-wrapper" id="wdl-archive-infinite-scroll-wrapper">
          <?php while (have_posts()): ?>
            ...
            <div class="col wdl-archive-infinite-scroll-post <?php if (get_field('HotDeal')) {
              echo esc_html('wdl-archive-primary');
            } else {
              echo esc_html('wdl-archive-default');
            } ?>">
              <div id="wdl-post-<?php the_ID(); ?>" class="card wdl-archive-card h-100">
                ...
                <div class="card-body wdl-archive-card-body">
                  <div class="wdl-badge-container mb-2">
                    ...
                    <?php endif; ?>
                    <?php if ($hotDeal && in_array('Hot Deal', $hotDeal)): ?>
