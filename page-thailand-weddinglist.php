...
<section class="position-relative py-3">
  <div class="container-xl position-relative z-1">
    <div class="row g-4 justify-content-center min-vh-100 mt-0">
            ...
            <form id="businessSignUp" action="<?php echo admin_url('admin-ajax.php'); ?>" method="post">
                ...
                <div class="col-md-12 d-flex flex-column flex-xl-row align-items-xl-center gap-xl-5">
                  ...
                  <div class="position-relative w-100">
                    <select name="channel" id="channel" class="select2" required>
                      ...
                      <option>อื่น ๆ โปรดระบุ</option>
                    </select>
                  </div>
                </div>
              </div>
              <hr class="my-4">
              <div class="col-md-12 card p-3 rounded-4">
                <div class="fw-semibold mb-3"><?php _e('ประเภทของบริการที่สนใจ', 'wdl')?>&nbsp;<span class="text-red">*</span></div>
                <div class="row row-cols-2 g-2">
                  <div class="wdl-checkbox col">
                    <input type="checkbox" name="interest" id="interest-1" value="ต่ำกว่า 100 คน" required/>
                    <label for="interest-1"><?php _e('โรงแรมหรือสถานที่จัดงานแต่ง', 'wdl')?></label>
                  </div>
                  <div class="wdl-checkbox col">
                    <input type="checkbox" name="interest" id="interest-2" value="101 - 300 คน" required/>
                    <label for="interest-2"><?php _e('ร้านชุดแต่งงาน', 'wdl')?></label>
                  </div>
                  <div class="wdl-checkbox col">
                    <input type="checkbox" name="interest" id="interest-3" value="301 - 500 คน" required/>
                    <label for="interest-3"><?php _e('Organizer / Wedding Planner', 'wdl')?></label>
                  </div>
                  <div class="wdl-checkbox col">
                    <input type="checkbox" name="interest" id="interest-4" value="500 ท่านขึ้นไป" required/>
                    <label for="interest-4"><?php _e('ร้านแหวนแต่งงานและจิวเวลรี่', 'wdl')?></label>
                  </div>
                  <div class="wdl-checkbox col">
                    <input type="checkbox" name="interest" id="interest-5" value="500 ท่านขึ้นไป" required/>
                    <label for="interest-5"><?php _e('ช่างภาพ / วิดีโอ', 'wdl')?></label>
                  </div>
                  <div class="wdl-checkbox col">
                    <input type="checkbox" name="interest" id="interest-6" value="500 ท่านขึ้นไป" required/>
                    <label for="interest-6"><?php _e('ของชำร่วย / การ์ดแต่งงาน', 'wdl')?></label>
                  </div>
                  <div class="wdl-checkbox col">
                    <input type="checkbox" name="interest" id="interest-7" value="500 ท่านขึ้นไป" required/>
                    <label for="interest-7"><?php _e('Photo Booth & Interactive Entertainment', 'wdl')?></label>
                  </div>
                  <div class="wdl-checkbox col">
                    <input type="checkbox" name="interest" id="interest-8" value="500 ท่านขึ้นไป" required/>
                    <label for="interest-8"><?php _e('Beauty / Makeup / Hairdo', 'wdl')?></label>
                  </div>
                  <div class="wdl-checkbox col">
                    <input type="checkbox" name="interest" id="interest-9" value="500 ท่านขึ้นไป" required/>
                    <label for="interest-9"><?php _e('Pre-wedding Travel / Honeymoon Package', 'wdl')?></label>
                  </div>
                  <div class="wdl-checkbox col">
                    <input type="checkbox" name="interest" id="interest-10" value="500 ท่านขึ้นไป" required/>
                    <label for="interest-10"><?php _e('ธุรกิจเกี่ยวกับการเงิน / บัตรเครดิต / สินเชื่อ', 'wdl')?></label>
                  </div>
                  <div class="wdl-checkbox col">
                    <input type="checkbox" name="interest" id="interest-11" value="500 ท่านขึ้นไป" required/>
              ...
              <div class="row row-cols-1 row-cols-lg-2 g-3">
                ...
                <div class="col mb-3">
                  ...
                  <input name="contactLine" id="contactLine" type="email" placeholder="<?php _e('Line ID','wdl')?>" />
                </div>
              </div>
              <div class="col-md-12 gap-3">
                <label for="province"><?php _e('จังหวัด', 'wdl')?><span class="text-red">*</span></label>
                <div class="position-relative w-100">
