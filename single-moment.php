...
<main>
            ...
            <div class="wdl-metadata gap-1">
              ...
              <div class="d-flex">
                ...
                <span>
                  ...
                  <a class="text-accent" target="_blank" href="<?php echo get_field('MomentMap')?>"><?php _e('ดูแผนที่', 'wdl')?></a>
                </span>
              </div>
              <?php } ?>
            </div>
              ...
              <div class="row mb-2 mb-lg-3 g-2 g-lg-3">
                <div class="col-12">
                  <div class="form-floating">
                    <input name="name" id="name" class="form-control" type="text" placeholder="ชื่อ - นามสกุล" required>
                    <label for="name">ชื่อ - นามสกุล</label>
                  </div>
                </div>
                <div class="col-12">
                  <div class="form-floating">
                    <input name="tel" id="tel" class="form-control" type="text" placeholder="เบอร์โทรติดต่อ" required>
                    <label for="tel">เบอร์โทรติดต่อ</label>
                  </div>
                </div>
                <div class="col-12">
                  <div class="form-floating">
                    <input name="date" id="date" class="form-control" type="date" placeholder="จองวันที่" required>
                    <label for="date">จองวันที่</label>
                  </div>
                </div>
                <div class="col-12">
                  <div class="form-floating">
                    <select name="package" id="package" class="form-control" placeholder="แพ็คเกจที่ต้องการ" required>
                      <?php
                      foreach($momentPackage as $package) { 
                        if($package['MomentPackagePrice'] && $package['MomentPackageUnit']) {
                    ...
                    <label for="package">แพ็คเกจที่ต้องการ</label>
                  </div>
                </div>
              </div>
              <button type="submit" class="mb-2 mb-lg-3 w-100 wdl-btn-line-cta d-lg-none">ซื้อแพ็คเกจผ่าน Line</button>
              <button type="submit" class="mb-2 mb-lg-3 w-100 wdl-btn-line-cta d-none d-lg-flex">สแกน QR - ซื้อแพ็คเกจผ่าน Line</button>
              <?php 
              $brochure = get_field('MomentBrochure');
              if($brochure) {?>
              <a href="#brochure" data-bs-toggle="modal" class="w-100 wdl-link-brochure">ดูโบรชัวร์โรงแรม</a>
              <?php } ?>
            </form>
          </div>
          <div class="wdl-layout-card">
  ...
  <div class="modal fade wdl-gallery-modal" id="modalLineQr">
    <div class="modal-dialog modal-dialog-centered modal-lg">
      <div class="modal-content mb-0">
        <div class="modal-body">
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
          <div class="text-center py-3">
            <div id="wdl-lineqr-container"></div>
            <h2><?php _e('กรุณาสแกน QR Code เพื่อติดต่อแอดมินผ่านไลน์','wdl') ?></h2>
          </div>
        </div>
      </div>
    </div>
