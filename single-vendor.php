...
<?php if(isset($campaignModeEnabled) && isset($campaignRelated['Vendor']) && in_array(get_the_ID(), $campaignRelated['Vendor'])) {
  ...
  <section class="pt-3 pb-4 overflow-hidden">
    ...
    <div class="container-xl">
      <div class="row">
        <div class="col-lg-9">
          <div class="row mb-4">
            ...
            <div class="col-lg mb-3 mb-lg-0 pt-lg-3">
              ...
              if ($relatedVenue): ?>
              <p class="wdl-archive-location mb-2"><a href="<?php echo esc_html($relatedVenuePermalink) ?>">
              ...
              if ($address2): ?>
              <p class="wdl-metadata wdl-archive-pin mb-2">
                <span>
              ...
              <p class="wdl-metadata wdl-archive-facebook mb-2">
              ...
              <p class="wdl-metadata wdl-archive-instagram mb-2">
          ...
          <nav class="d-flex w-full mb-4 text-center">
            <?php if(get_the_content() && get_the_content() !== ''): ?>
            <a class="d-block p-2 flex-fill border-top border-bottom" href="#content">เนื้อหา</a>
            <?php endif; ?>
            <?php 
            $coupon = get_posts(
              array(
            ...
            if($coupon): ?>
            <a class="d-block p-2 flex-fill border-top border-bottom" href="#coupon">คูปองที่ร่วมรายการ</a>
            <?php endif; ?>
            <?php if(!in_array(('Free microsite'), get_field('Status')) && have_rows('Album')): ?>
            <a class="d-block p-2 flex-fill border-top border-bottom" href="#album">อัลบั้ม</a>
            <?php endif; ?>
            <?php if(!in_array(('Free microsite'), get_field('Status')) && have_rows('Pricing')): ?>
            <a class="d-block p-2 flex-fill border-top border-bottom" href="#pricing">ข้อมูลค่าใช้จ่าย</a>
            <?php endif; ?>
          </nav>
          ...
          <?php
          if ($coupon): ?>
            <h2 id="coupon" class="h3 mb-1"><?php _e('คูปองที่ร่วมรายการ', 'wdl') ?></h2>
          ...
          <?php if(!in_array(('Free microsite'), get_field('Status')) && have_rows('Album')): ?>
          <div id="album" class="wdl-archive py-4">
            <h2 class="h3 mb-1">
              <?php _e('อัลบั้ม', 'wdl') ?>
            </h2>
            <div class="row row-cols-2 row-cols-md-3 row-cols-lg-4 g-5">
              <?php
                ...
                ?>
                <div class="col">
                  <a class="wdl-album-toggle p-0" href="#album-<?php echo $alb['index'];?>">
          ...
          <?php if(!in_array(('Free microsite'), get_field('Status')) && have_rows('Pricing')): ?>
          <?php $pricings = [];?>
          <div id="pricing" class="wdl-archive py-4">
            <h2>
        ...
        <div class="col-lg-3 d-flex flex-column">
          <div class="card p-3 h-auto mb-3 shadow-sm">
            <?php if(get_field('MinPrice')) : ?>
            <div class="d-flex justify-content-between align-baseline mb-3">
              <small class="fw-normal h4 mb-0">เริ่มต้น</small> <div class="h2 mb-0">฿<?php echo number_format(get_field('MinPrice'))?></div>
            </div>
            <a href="#pricing" class="d-block text-center mb-3">
              <?php _e('ดูข้อมูลค่าใช้จ่าย', 'wdl'); ?>
            </a>
            <?php endif; ?>
            

            <a id="apply-cta" href="#apply" class="wdl-btn-lg d-block mb-3 text-center" data-bs-toggle="modal"
              data-dlev="buttonClick"
              data-dlcomp="button - vendor - cta"
              data-dltgt="<?php the_title() ?>">
              <?php _e('คลิกขอแพ็กเกจ', 'wdl'); ?>
  ...
  <div class="modal fade wdl-gallery-modal" id="modal-album">
    <div class="modal-dialog modal-dialog-centered modal-xl">
      <div class="modal-content mb-0">
        <div class="modal-body">
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
          ...
          <?php 
            ...
            <?php if($albumImages) :?>
              <div  id="album-<?php echo $albumIndex;?>" class="swiper wdl-gallery-modal-swiper wdl-album-swiper d-none">
                <div class="swiper-wrapper">
                  <?php foreach($albumImages as $image) :?>
                    <div class="swiper-slide wdl-gallery-modal-item">
                        <img class="object-fit-contain" src="<?php echo $image['url'] ?>" alt="<?php the_sub_field('AlbumTitle'); ?>">
                    </div>
                  <?php endforeach;?>
                </div>
                <div class="swiper-navigation swiper-navigation-small">
