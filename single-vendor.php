...
<main>
	...
	<section>
      ...
      <div class="row justify-content-center my-5">
				<div class="col-xl-8">
					<?php if(get_field('TeaserVideo')) {
						?>
						<iframe class="wdl-iframe" src="<?php echo get_field('TeaserVideo') ?>" width="750" height="420"></iframe>
						<?php
					}
					?>
				</div>
												...
												<div class="text-primary fw-semibold">
													<?php if (get_sub_field('PricingName')): ?>
														...
														if ($pricingImages):
															...
															<div class="row g-3 wdl-gallery wdl-hero-gallery">
																<div class="col position-relative">
																	<div id="hero-gallery" class="swiper wdl-hero-gallery-swiper">
																		<div class="swiper-wrapper">
																			<?php
																			// Grab each image.
														...
														<p class="mb-0"><?php echo esc_html(get_sub_field('PricingName')); ?></p>
														<p class="text-sm mb-0"><?php echo esc_html(get_sub_field('PricingDescription')); ?></p>
														<p class="text-sm"><?php _e('ราคา','ราคา')?> : <?php echo esc_html(number_format(get_sub_field('PricingStart')))?> <?php if(get_sub_field('PricingEnd')) {?> - <?php echo esc_html(number_format(get_sub_field('PricingEnd'))); }?></p>
													<?php endif; ?>
												</div>
											</div>
										</div>
			...
			<div class="container-xl">
				<div class="row align-items-center">
					<div class="col-12">
						<div class="wdl-archive <?php echo esc_attr($atts['class']); ?>">
							<h3 class="h4 mb-4">
								<?php _e('บทความที่เกี่ยวข้อง', 'Related Posts') ?>
							</h3>
							<div class="mb-3">
								<?php
								if ($tagsArray) {
				...
				<div class="row align-items-center">
					<div class="col-12">
						<div class="wdl-archive">
							<h3 class="h4 mb-4">
								<?php _e('สถานที่จัดงานแต่งงานอื่นที่คุณอาจสนใจ', 'Other Wedding Venues') ?>
							</h3>
							<div class="swiper wdl-archive-swiper overflow-visible">
								<div class="swiper-wrapper">
									<?php foreach ($relatedVenues as $relatedVenue): ?>
										<div id="wdl-post-<?php echo $relatedVenue->ID; ?>" class="swiper-slide card wdl-archive-card <?php echo esc_attr($atts['class_single']); ?>">
											...
											<div class="card-body wdl-archive-card-body">
												<h3 class="wdl-archive-title"><a href="<?php echo get_permalink($relatedVenue->ID); ?>">
														<?php the_title($relatedVenue->ID); ?>
													</a></h3>
